...
management_hostName=ibm-gen2host-${privateIP//./-}
networkIPrange=$(echo ${privateIP}|cut -f1-3 -d .)
host_prefix=$(echo ${management_hostName}|cut -f1-5 -d -)
hostnamectl set-hostname ${management_hostName}
...
#update the lsf management_host hostname
sed -i "s/lsfservers/servershosts/" $IBM_CLOUD_USER_DATA_FILE
grep -rli 'lsfservers' ${LSF_CONF}/*|xargs sed -i "s/lsfservers/${management_hostName}/g"
sed -i "s/ServerHostPlaceHolder/${management_hostName}/" $IBM_CLOUD_USER_DATA_FILE
